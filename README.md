## LS-GKM + gkmexplain: A new gkm-SVM software for large-scale datasets, with explanations
...
Although I haven't implemented support for multiple threads, the process of generating explanations can be parallelized by sequence; I recommend splitting your input sequences file into multiple smaller files, running gkmexplain in parallel on each smaller file, and concatenating the results.
...
Please create a github issue (preferred) or contact Avanti Shrikumar (avanti dot shrikumar at gmail) if you have questions about gkmexplain.
