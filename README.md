...
To be updated when paper is online. For now, cite the repository `github.com/kundajelab/gkmexplain`
...
You use `gexplain` to explain the predictions on sequences
...
Please see the colab example notebooks at github.com/kundajelab/gkmexplain for code demonstrating how to visualize the resulting scores.
